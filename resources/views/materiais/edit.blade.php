                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <textarea name="descricao" id="descricao" rows="4"
                                                ...
                                                class="pl-10 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-logo-sky focus:border-transparent @error('descricao') border-red-500 @enderror">{{ old('descricao', $material->descricao) }}</textarea>
                                        </div>
                                        @error('descricao')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                            ...
                                            <a href="{{ route('materiais.download', $material) }}"
                                                class="inline-flex items-center px-3 py-2 bg-brand-600 text-white text-xs font-medium rounded-lg hover:bg-brand-700 transition-colors">
