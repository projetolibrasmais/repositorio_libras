<x-app-layout>
    ...
    <div class="p-2 w-full h-full">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <!-- Page Header -->
                <x-page-header title="Visualizar Permissão"
                    description="Detalhes completos da permissão {{ $permission->name }}">
                    <x-slot name="action">
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-900 bg-gray-50 rounded-lg p-3">
                                        {{ $permission->description ?? 'Nenhuma descrição fornecida.' }}
                                    </p>
                                </div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1 ml-6">
                                        {{ $permission->updated_at->format('H:i:s') }}
                                    </p>
                                </div>
                                ...
                                <div class="pt-3 border-t border-gray-100">
                                    <p class="text-xs text-gray-500">
                                        ...
                                        Criado {{ $permission->created_at->diffForHumans() }}
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center justify-between py-3">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm font-medium text-gray-900">Funções</p>
                                            <p class="text-xs text-gray-500">Com esta permissão</p>
                                        </div>
                                    </div>
