<x-public-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-4xl font-bold text-brand-600 mb-4">{{ __('Categorias') }}</h1>
                           ...
                           class="bg-white rounded-lg transition-shadow p-6 border border-gray-200 hover:border-logo-sky group">
                            <div class="flex items-start gap-4">
                                <div class="flex-shrink-0 w-16 h-16 bg-brand-100 rounded-full flex items-center justify-center">
                                    <i class="ph ph-folder text-brand-600 text-3xl"></i>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <h3 class="font-semibold text-xl text-gray-900 group-hover:text-brand-600 transition-colors mb-2">
                                        {{ $categoria->nome }}
                                    </h3>
