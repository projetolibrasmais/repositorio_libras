<x-public-layout>
    ...
    <div class="flex items-center justify-center py-2 px-10">
        ...
        <div class="mx-4">
            <i class="ph ph-hand-waving bg-gradient-to-r from-brand-600 via-logo-green to-logo-pink text-transparent bg-clip-text text-3xl"></i>
        </div>
        <div class="flex-grow border-t border-gray-300"></div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <h1 class="text-4xl font-bold text-brand-600 mb-8 text-center">Perguntas Frequentes</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div>
                ...
                <x-acordeon-faq nome="Quem pode usar a Plataforma Digital Libras+?"
