            ...
            <div class="p-6">
                ...
                @if ($role->permissions()->count() > 0)
                    <div class="mt-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                            <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                                <i class="ph ph-lock-key mr-2 text-brand-600"></i>
                        ...
                        <div class="p-6">
                            <div class="flex flex-wrap gap-2">
                                @foreach ($role->permissions as $permission)
                                    <span
                                        class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium bg-brand-100 text-brand-800 border border-brand-100">
