                        ...
                        <div class="lg:col-span-3">
                            <div class="bg-white border border-gray-200 rounded-lg p-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <!-- Configuração de Mão -->
                                    <div>
                                        <label for="config_mao" class="block text-sm font-medium text-gray-700 mb-1">
                                    ...
                                    <div>
                                        <label for="ponto_articulacao" class="block text-sm font-medium text-gray-700 mb-1">
                                    ...
                                    <div>
                                        <label for="orientacao_palma_mao" class="block text-sm font-medium text-gray-700 mb-1">
                                    ...
                                    <!-- Movimento -->
                                    <div>
                                        <label for="movimento" class="block text-sm font-medium text-gray-700 mb-1">
                                    ...
                                    <div>
                                        <label for="expressao_nao_manual" class="block text-sm font-medium text-gray-700 mb-1">
