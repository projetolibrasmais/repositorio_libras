                        ...
                        <div class="lg:col-span-2">
                            <div class="bg-white border border-gray-200 rounded-lg p-6">
                                ...
                                <div class="space-y-4">
                                    <!-- Palavra_Portugues -->
                                    <div>
                                        <label for="palavra_portugues" class="block text-sm font-medium text-gray-700 mb-1">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" 
                                                   name="palavra_portugues" 
                                                   id="palavra_portugues"
                                                   value="{{ old('palavra_portugues') }}"
                                                   required
                                                   placeholder=""
                                    ...
                                    <div>
                                        <label for="instrucao_execucao" class="block text-sm font-medium text-gray-700 mb-1">
                                            Instrução de Execução 
                                        </label>
                                        <div class="relative">
                                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            ...
                                            <input type="text" 
                                                   name="instrucao_execucao" 
                                                   id="instrucao_execucao"
                                                   value="{{ old('instrucao_execucao') }}"
                                                   placeholder=""
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <select
                                                ...
                                                <option value="catalogado" {{ old('status') == 'catalogado' ? 'selected' : '' }}>
                                                    Catalogado
                                                </option>

                                                <option value="em_validacao" {{ old('status') == 'em_validacao' ? 'selected' : '' }}>
                                                    Em Validação
                                                </option>
                                    ...
                                    <!-- Video Principal Id -->
                                    <div>
                                        <label for="video_principal_id" class="block text-sm font-medium text-gray-700 mb-1">
                                            ID Vídeo 
                                        </label>
                                        <div class="relative">
                                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            ...
                                            <input type="text" 
                                                   name="video_principal_id" 
                                                   id="video_principal_id"
                                                   value="{{ old('video_principal_id') }}"
                                                   placeholder=""
                                                   class="pl-10 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('video_principal_id') border-red-500 @enderror">
                                        </div>
                                        @error('video_principal_id')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="bg-white border border-gray-200 rounded-lg p-6">
                                        ...
                                        <p class="text-sm text-gray-600 mb-4">Selecione as categorias relacionadas a este sinal.</p>
                                                ...
                                                @foreach($categorias as $categoria)
                                                    <div class="flex items-start">
                                                        ...
                                                        <div class="ml-2 text-sm">
                                                            <label for="categoria_{{ $categoria->id }}" class="font-medium text-gray-700 cursor-pointer">
                                                                {{ $categoria->nome }}
                                                            </label>

                                                            @if(!empty($categoria->descricao))
                                                                <p class="text-gray-500 text-xs">{{ $categoria->descricao }}</p>
                                                            @endif
                                                        </div>
                                                    </div>
                                                @endforeach
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="mt-2 text-sm text-blue-700">
                                            <ul class="list-disc list-inside space-y-1">
                                                <li>O nome do sinal deve ser único</li>
                                                <li>Na definição deve haver uma explicação sobre o sinal</li>                                                
