        ...
        <div class="flex flex-col h-full">
            ...
            <div class="flex items-center justify-between p-4 pb-3 border-b border-slate-200">
                ...
                <button @click="collapsed = !collapsed" 
                    ...
                    <svg x-show="collapsed" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display: none;">
                    ...
                    <li x-data="{ submenuOpen: false }">
                        <button @click="submenuOpen = !submenuOpen" 
                            ...
                            <span class="flex items-center">
                                <span class="grid place-items-center shrink-0" :class="!collapsed || window.innerWidth < 1024 ? 'me-3' : ''">
                                    <svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-5 w-5">
                                        <path d="M7 12.5C7.27614 12.5 7.5 12.2761 7.5 12C7.5 11.7239 7.27614 11.5 7 11.5C6.72386 11.5 6.5 11.7239 6.5 12C6.5 12.2761 6.72386 12.5 7 12.5Z" fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                                        ...
                                        <path d="M17 12.5C17.2761 12.5 17.5 12.2761 17.5 12C17.5 11.7239 17.2761 11.5 17 11.5C16.7239 11.5 16.5 11.7239 16.5 12C16.5 12.2761 16.7239 12.5 17 12.5Z" fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            <span x-show="(!collapsed || window.innerWidth < 1024) && submenuOpen" 
                                ...
                                <svg class="h-4 w-4 transform transition-transform duration-200" :class="submenuOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <ul x-show="submenuOpen && (!collapsed || window.innerWidth < 1024)" 
                            ...
                            style="display: none;">
                            <li>
                                <a href="#" class="block py-2 px-3 text-sm rounded-md text-slate-600 hover:text-slate-800 hover:bg-slate-100 transition-colors">
                                    Inbox
                                </a>
                            </li>
                            <li>
